      ...
      <button className="group relative dark:bg-neutral-800 bg-neutral-200 rounded-full p-px mb-4 overflow-hidden">
        <span className="absolute inset-0 rounded-full overflow-hidden">
          <span className="inset-0 absolute pointer-events-none select-none">
            <span className="block -translate-x-1/2 -translate-y-1/3 size-24 blur-xl background-[linear-gradient(135deg, rgb(122, 105, 249), rgb(242, 99, 120), rgb(245, 131, 63))]"></span>
          </span>
        </span>

        <span className="inset-0 absolute pointer-events-none select-none animation-[10s ease-in-out 0s infinite alternate none running border-glow-translate]">
          <span
            className="block z-0 h-full w-12 blur-xl -translate-x-1/2 rounded-full animation-[10s ease-in-out 0s infinite alternate none running border-glow-scale]
        ...
        <span className="flex items-center justify-center gap-1 relative z-[1] dark:bg-neutral-950/90 bg-neutral-50/90 rounded-full py-2 px-4 pl-2 w-full">
          <span className="relative group-hover:scale-105 transition-transform group-hover:rotate-[360deg] duration-500">
            <svg
              ...
              className="opacity-80 dark:opacity-100 animation-[14s cubic-bezier(0.68, -0.55, 0.27, 1.55) 0s infinite alternate none running star-rotate]"
            >
              <path
            ...
            <span
              className="rounded-full size-11 absolute opacity-0 dark:opacity-30 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 blur-lg animation-[14s ease-in-out 0s infinite alternate none running star-shine]
